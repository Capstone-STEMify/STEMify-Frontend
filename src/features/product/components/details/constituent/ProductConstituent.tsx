...
const WhatsIncluded: React.FC = () => {
  ...
  const items = [
    ...
    },
    {
      name: 'mBot2 Shield',
      quantity: 'x 1',
      image: 'https://images.unsplash.com/photo-1589561084283-930aa7b7b9b4?w=200&h=200&fit=crop'
    },
    {
    ...
    },
    {
      name: 'Chassis',
      quantity: 'x 1',
      image: 'https://images.unsplash.com/photo-1581092162384-8987c1d64718?w=200&h=200&fit=crop'
    },
    {
      name: 'Mini wheel',
      quantity: 'x 1',
    ...
    {
      name: 'Line-following track map',
      quantity: 'x 1',
      image: 'https://images.unsplash.com/photo-1569144157591-c60f3f82f137?w=200&h=200&fit=crop'
    },
    {
      name: 'Screw and Bolt Pack',
      quantity: 'x 1',
        ...
        <div className='grid grid-cols-4 gap-4 md:grid-cols-6 lg:grid-cols-8'>
          {items.map((item, idx) => (
            ...
            >
              ...
              <h4 className='mb-1 text-center text-xs leading-tight font-medium text-gray-900'>{item.name}</h4>
