      ...
      <div className='my-10 grid grid-cols-1 rounded-lg border md:grid-cols-2'>
        <div className='p-6 md:border-r'>
          ...
          <div className='prose prose-sm max-w-none text-gray-700'>
            <p>
              Select a public website that you use enough to be familiar with what a typical user may want to do. This
              website should not require the peer reviewer to sign up for an account...
            </p>
          </div>
        </div>
      ...
      <div className='mt-8 border-t pt-6'>
        ...
        {isReviewed ? (
          <div className='mt-4 rounded-md border bg-gray-50 p-4'>
            <p className='text-sm text-gray-700 italic'>{submission.comment || 'No comment left.'}</p>
          </div>
        ) : (
          <div className='mt-4'>
            ...
            <div className='flex items-start gap-3'>
              ...
              <Textarea placeholder='Share your thoughts...' className='flex-1' rows={4} />
            </div>
