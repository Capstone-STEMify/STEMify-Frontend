...
const ContactForm = () => {
  ...
  return (
    <motion.div
      className="w-full lg:w-1/2 px-24 py-8"
      variants={formVariants}
      initial="hidden"
      animate="visible"
    >
      <h2 className="text-4xl font-semibold mb-2 text-sky-400">Get in touch</h2>
      <p className="text-gray-600 font-semibold mb-8">We are here for you! How can we help?</p>
      <form>
        <div className="mb-6">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          type="submit"
          className="w-full bg-sky-400 text-white font-bold py-3 px-6 rounded-lg hover:bg-opacity-90 transition-all duration-300"
        >
          Submit
        </motion.button>
      </form>
