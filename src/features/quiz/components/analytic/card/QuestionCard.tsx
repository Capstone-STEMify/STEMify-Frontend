...
const StatisticsBox = ({statisticData}: StatisticBoxProps) => (
  <div className='space-y-4 rounded-lg border p-6'>
    ...
    <div className='flex items-center gap-3'>
      <ProgressCircle value={statisticData.correctRate} size={28} className='text-green-500' strokeWidth={3} showPercentageText={false} />
      <div>
      ...
      <CardContent className='p-6'>
        <div className='mb-6 flex items-center justify-between'>
          <div className='flex items-center gap-2 font-semibold'>
            ...
            <span>Question {questions.questionId} of {totalQuestion}</span>
          </div>
          <div className='flex items-center gap-4 text-sm text-gray-600'>
            <span className='flex items-center gap-1.5 font-bold bg-gray-100 p-2 rounded-md'>
