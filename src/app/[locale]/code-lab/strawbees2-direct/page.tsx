...
export default function Strawbees2DirectPage() {
  return (
    <div className='relative h-screen w-full'>
      {/* Header */}
      <div className='absolute top-4 left-4 z-10 bg-white/90 px-4 py-3 rounded-xl border shadow'>
        ...
        <p className='text-sm text-gray-500 mt-1'>
          Using useFrame for continuous animation
        </p>
      </div>
      ...
      {/* Status Panel */}
      <div className='absolute bottom-4 left-4 z-10 bg-white/90 px-4 py-3 rounded-xl border shadow'>
        <h3 className='font-semibold mb-2'>Direct Implementation:</h3>
      ...
      {/* Instructions */}
      <div className='absolute bottom-4 right-4 z-10 bg-white/90 px-4 py-3 rounded-xl border shadow max-w-xs'>
