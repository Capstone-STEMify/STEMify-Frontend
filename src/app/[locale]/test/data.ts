export type DemoItem = { name: string; children?: string[] }
const sampleTree: Record<string, DemoItem> = {
  root: { name: 'Root', children: ['fruit', 'vegetables', 'meals', 'dessert', 'drinks'] },
  fruit: { name: 'Fruit', children: ['apple', 'banana', 'orange', 'berries', 'lemon'] },
  apple: { name: 'Apple' },
  banana: { name: 'Banana' },
  orange: { name: 'Orange' },
  lemon: { name: 'Lemon' },
  ...
  vegetables: { name: 'Vegetables', children: ['tomato', 'carrot', 'cucumber', 'potato'] },
  tomato: { name: 'Tomato' },
  carrot: { name: 'Carrot' },
  cucumber: { name: 'Cucumber' },
  potato: { name: 'Potato' },
  meals: { name: 'Meals', children: ['america', 'europe', 'asia', 'australia'] },
  america: { name: 'America', children: ['burger', 'hotdog', 'pizza'] },
  burger: { name: 'Burger' },
  hotdog: { name: 'Hotdog' },
  pizza: { name: 'Pizza' },
  europe: { name: 'Europe', children: ['pasta', 'paella', 'schnitzel', 'risotto', 'weisswurst'] },
  pasta: { name: 'Pasta' },
  paella: { name: 'Paella' },
  ...
  australia: { name: 'Australia', children: ['potatowedges', 'pokebowl', 'lemoncurd', 'kumarafries'] },
  potatowedges: { name: 'Potato Wedges' },
  pokebowl: { name: 'Poke Bowl' },
  lemoncurd: { name: 'Lemon Curd' },
  kumarafries: { name: 'Kumara Fries' },
  dessert: { name: 'Dessert', children: ['icecream', 'cake', 'pudding', 'cookies'] },
...
export const createDemoData = (data = sampleTree) => {
  const syncDataLoader = { getItem: (id: string) => data[id], getChildren: (id: string) => data[id]?.children ?? [] }
